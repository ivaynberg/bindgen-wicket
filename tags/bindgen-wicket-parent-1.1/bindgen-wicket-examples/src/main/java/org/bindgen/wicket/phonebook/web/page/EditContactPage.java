...
import static org.bindgen.wicket.BindingModel.*;
...
public class EditContactPage extends BasePage
{
    ...
    public EditContactPage(Page backPage, IModel< ? > contactModel)
    {
        ...
        form.add(new TextField<String>("firstname", of(bind(this).contact().firstname()))
                .setRequired(true).add(StringValidator.maximumLength(32)));

        form.add(new TextField<String>("lastname", of(bind(this).contact().lastname()))
                .setRequired(true).add(StringValidator.maximumLength(32)));

        form.add(new TextField<String>("phone", of(bind(this).contact().phone())).setRequired(true)
                .add(StringValidator.maximumLength(16)));

        form.add(new TextField<String>("email", of(bind(this).contact().email())).setRequired(true)
